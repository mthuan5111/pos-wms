...
namespace POS_WMS.Application.Interfaces
{
    ...
    {
        Task RecordMovementAsync(int productId, Domain.Enums.StockMovementType type, int quantity, string referenceType, int? referenceId, int balanceAfter, string createdBy);
